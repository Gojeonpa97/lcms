...
<%@ page import="com.lcms.common.shiro.utils.ShiroUtils"%>
<html>
<head>
    <meta charset="utf-8">
    <title>后台管理系统</title>
    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-side layui-side-menu">
            <div class="layui-side-scroll">
                <div class="layui-logo" lay-href="pages/views/home/console.html">
                    <span>后台管理系统</span>
                </div>
        ...
        <div class="layui-body" id="LAY_app_body">
            <div class="layadmin-tabsbody-item layui-show">
                <iframe src="pages/views/home/console.html" frameborder="0" class="layadmin-iframe"></iframe>
            </div>
        </div>
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data.data ,function (index, menu){
                ...
                menuLi += '<i class="layui-icon '+ menu.icon +'"></i>';
                menuLi += '<cite>'+menu.name+'</cite>';
                menuLi += '</a>';
                if(menu.childrenMenus.length > 0){
                    menuLi += '<dl class="layui-nav-child">';
                    $.each(menu.childrenMenus, function (index, childrenMenu) {
                        menuLi += '<dd>';
                        menuLi += '<a lay-href="'+ childrenMenu.url +'">'+ childrenMenu.name +'</a>';
                        menuLi += '</dd>';
                    });
                    menuLi += '</dl>';
                }
            ...
            $("#LAY-system-side-menu").append(menuLi);
        },
        error: function (data) {
        }
    });
